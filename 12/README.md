...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `12`.
...
- **Naming**: SHA-1 hash with `12` prefix removed (full hash = `12` + filename)
...
- **Do not rename** — Folder name (`12`) is part of the SHA-1 addressing scheme

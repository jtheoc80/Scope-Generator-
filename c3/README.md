...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c3`.
...
- **Naming**: SHA-1 hash with `c3` prefix removed (full hash = `c3` + filename)
...
- **Do not rename** — Folder name (`c3`) is part of the SHA-1 addressing scheme

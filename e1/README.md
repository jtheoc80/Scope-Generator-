...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e1`.
...
- **Naming**: SHA-1 hash with `e1` prefix removed (full hash = `e1` + filename)
...
- **Do not rename** — Folder name (`e1`) is part of the SHA-1 addressing scheme

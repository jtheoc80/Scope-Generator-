...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `3e`.
...
- **Naming**: SHA-1 hash with `3e` prefix removed (full hash = `3e` + filename)
...
- **Do not rename** — Folder name (`3e`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e3`.
...
- **Naming**: SHA-1 hash with `e3` prefix removed (full hash = `e3` + filename)
...
- **Do not rename** — Folder name (`e3`) is part of the SHA-1 addressing scheme

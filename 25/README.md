...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `25`.
...
- **Naming**: SHA-1 hash with `25` prefix removed (full hash = `25` + filename)
...
- **Do not rename** — Folder name (`25`) is part of the SHA-1 addressing scheme

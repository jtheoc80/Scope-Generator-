...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `97`.
...
- **Naming**: SHA-1 hash with `97` prefix removed (full hash = `97` + filename)
...
- **Do not rename** — Folder name (`97`) is part of the SHA-1 addressing scheme

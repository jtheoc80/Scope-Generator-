...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `8c`.
...
- **Naming**: SHA-1 hash with `8c` prefix removed (full hash = `8c` + filename)
...
- **Do not rename** — Folder name (`8c`) is part of the SHA-1 addressing scheme

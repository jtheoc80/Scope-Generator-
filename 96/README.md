...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `96`.
...
- **Naming**: SHA-1 hash with `96` prefix removed (full hash = `96` + filename)
...
- **Do not rename** — Folder name (`96`) is part of the SHA-1 addressing scheme

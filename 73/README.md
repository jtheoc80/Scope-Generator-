...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `73`.
...
- **Naming**: SHA-1 hash with `73` prefix removed (full hash = `73` + filename)
...
- **Do not rename** — Folder name (`73`) is part of the SHA-1 addressing scheme

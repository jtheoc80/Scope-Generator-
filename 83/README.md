...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `83`.
...
- **Naming**: SHA-1 hash with `83` prefix removed (full hash = `83` + filename)
...
- **Do not rename** — Folder name (`83`) is part of the SHA-1 addressing scheme

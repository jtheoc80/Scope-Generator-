...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b3`.
...
- **Naming**: SHA-1 hash with `b3` prefix removed (full hash = `b3` + filename)
...
- **Do not rename** — Folder name (`b3`) is part of the SHA-1 addressing scheme

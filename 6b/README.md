...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `6b`.
...
- **Naming**: SHA-1 hash with `6b` prefix removed (full hash = `6b` + filename)
...
- **Do not rename** — Folder name (`6b`) is part of the SHA-1 addressing scheme

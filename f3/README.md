...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f3`.
...
- **Naming**: SHA-1 hash with `f3` prefix removed (full hash = `f3` + filename)
...
- **Do not rename** — Folder name (`f3`) is part of the SHA-1 addressing scheme

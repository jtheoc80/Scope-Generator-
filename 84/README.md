...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `84`.
...
- **Naming**: SHA-1 hash with `84` prefix removed (full hash = `84` + filename)
...
- **Do not rename** — Folder name (`84`) is part of the SHA-1 addressing scheme

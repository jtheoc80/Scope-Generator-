...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c6`.
...
- **Naming**: SHA-1 hash with `c6` prefix removed (full hash = `c6` + filename)
...
- **Do not rename** — Folder name (`c6`) is part of the SHA-1 addressing scheme

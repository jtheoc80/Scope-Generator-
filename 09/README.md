...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `09`.
...
- **Naming**: SHA-1 hash with `09` prefix removed (full hash = `09` + filename)
...
- **Do not rename** — Folder name (`09`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `cf`.
...
- **Naming**: SHA-1 hash with `cf` prefix removed (full hash = `cf` + filename)
...
- **Do not rename** — Folder name (`cf`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `94`.
...
- **Naming**: SHA-1 hash with `94` prefix removed (full hash = `94` + filename)
...
- **Do not rename** — Folder name (`94`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `1b`.
...
- **Naming**: SHA-1 hash with `1b` prefix removed (full hash = `1b` + filename)
...
- **Do not rename** — Folder name (`1b`) is part of the SHA-1 addressing scheme

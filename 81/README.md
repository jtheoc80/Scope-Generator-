...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `81`.
...
- **Naming**: SHA-1 hash with `81` prefix removed (full hash = `81` + filename)
...
- **Do not rename** — Folder name (`81`) is part of the SHA-1 addressing scheme

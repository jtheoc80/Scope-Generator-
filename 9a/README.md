...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `9a`.
...
- **Naming**: SHA-1 hash with `9a` prefix removed (full hash = `9a` + filename)
...
- **Do not rename** — Folder name (`9a`) is part of the SHA-1 addressing scheme

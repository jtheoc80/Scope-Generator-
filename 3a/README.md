...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `3a`.
...
- **Naming**: SHA-1 hash with `3a` prefix removed (full hash = `3a` + filename)
...
- **Do not rename** — Folder name (`3a`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `99`.
...
- **Naming**: SHA-1 hash with `99` prefix removed (full hash = `99` + filename)
...
- **Do not rename** — Folder name (`99`) is part of the SHA-1 addressing scheme

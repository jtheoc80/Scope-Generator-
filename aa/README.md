...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `aa`.
...
- **Naming**: SHA-1 hash with `aa` prefix removed (full hash = `aa` + filename)
...
- **Do not rename** — Folder name (`aa`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ab`.
...
- **Naming**: SHA-1 hash with `ab` prefix removed (full hash = `ab` + filename)
...
- **Do not rename** — Folder name (`ab`) is part of the SHA-1 addressing scheme

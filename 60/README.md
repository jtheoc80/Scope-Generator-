...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `60`.
...
- **Naming**: SHA-1 hash with `60` prefix removed (full hash = `60` + filename)
...
- **Do not rename** — Folder name (`60`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `4c`.
...
- **Naming**: SHA-1 hash with `4c` prefix removed (full hash = `4c` + filename)
...
- **Do not rename** — Folder name (`4c`) is part of the SHA-1 addressing scheme

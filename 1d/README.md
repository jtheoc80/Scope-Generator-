...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `1d`.
...
- **Naming**: SHA-1 hash with `1d` prefix removed (full hash = `1d` + filename)
...
- **Do not rename** — Folder name (`1d`) is part of the SHA-1 addressing scheme

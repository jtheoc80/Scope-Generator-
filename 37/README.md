...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `37`.
...
- **Naming**: SHA-1 hash with `37` prefix removed (full hash = `37` + filename)
...
- **Do not rename** — Folder name (`37`) is part of the SHA-1 addressing scheme

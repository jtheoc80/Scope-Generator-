...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c5`.
...
- **Naming**: SHA-1 hash with `c5` prefix removed (full hash = `c5` + filename)
...
- **Do not rename** — Folder name (`c5`) is part of the SHA-1 addressing scheme

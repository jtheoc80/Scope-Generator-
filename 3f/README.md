...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `3f`.
...
- **Naming**: SHA-1 hash with `3f` prefix removed (full hash = `3f` + filename)
...
- **Do not rename** — Folder name (`3f`) is part of the SHA-1 addressing scheme

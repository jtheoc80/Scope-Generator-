...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `0a`.
...
- **Naming**: SHA-1 hash with `0a` prefix removed (full hash = `0a` + filename)
...
- **Do not rename** — Folder name (`0a`) is part of the SHA-1 addressing scheme

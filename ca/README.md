...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ca`.
...
- **Naming**: SHA-1 hash with `ca` prefix removed (full hash = `ca` + filename)
...
- **Do not rename** — Folder name (`ca`) is part of the SHA-1 addressing scheme

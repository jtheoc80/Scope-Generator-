...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ff`.
...
- **Naming**: SHA-1 hash with `ff` prefix removed (full hash = `ff` + filename)
...
- **Do not rename** — Folder name (`ff`) is part of the SHA-1 addressing scheme

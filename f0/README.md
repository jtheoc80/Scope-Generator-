...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f0`.
...
- **Naming**: SHA-1 hash with `f0` prefix removed (full hash = `f0` + filename)
...
- **Do not rename** — Folder name (`f0`) is part of the SHA-1 addressing scheme

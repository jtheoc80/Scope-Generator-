...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `15`.
...
- **Naming**: SHA-1 hash with `15` prefix removed (full hash = `15` + filename)
...
- **Do not rename** — Folder name (`15`) is part of the SHA-1 addressing scheme

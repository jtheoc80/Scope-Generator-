...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `14`.
...
- **Naming**: SHA-1 hash with `14` prefix removed (full hash = `14` + filename)
...
- **Do not rename** — Folder name (`14`) is part of the SHA-1 addressing scheme

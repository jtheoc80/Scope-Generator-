...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `27`.
...
- **Naming**: SHA-1 hash with `27` prefix removed (full hash = `27` + filename)
...
- **Do not rename** — Folder name (`27`) is part of the SHA-1 addressing scheme

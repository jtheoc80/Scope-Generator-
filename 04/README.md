...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `04`.
...
- **Naming**: SHA-1 hash with `04` prefix removed (full hash = `04` + filename)
...
- **Do not rename** — Folder name (`04`) is part of the SHA-1 addressing scheme

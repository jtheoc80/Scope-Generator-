...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `4e`.
...
- **Naming**: SHA-1 hash with `4e` prefix removed (full hash = `4e` + filename)
...
- **Do not rename** — Folder name (`4e`) is part of the SHA-1 addressing scheme

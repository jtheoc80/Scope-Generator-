...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `7d`.
...
- **Naming**: SHA-1 hash with `7d` prefix removed (full hash = `7d` + filename)
...
- **Do not rename** — Folder name (`7d`) is part of the SHA-1 addressing scheme

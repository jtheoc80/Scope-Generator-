...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `5a`.
...
- **Naming**: SHA-1 hash with `5a` prefix removed (full hash = `5a` + filename)
...
- **Do not rename** — Folder name (`5a`) is part of the SHA-1 addressing scheme

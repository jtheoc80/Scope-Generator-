...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `fb`.
...
- **Naming**: SHA-1 hash with `fb` prefix removed (full hash = `fb` + filename)
...
- **Do not rename** — Folder name (`fb`) is part of the SHA-1 addressing scheme

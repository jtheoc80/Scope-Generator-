...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `df`.
...
- **Naming**: SHA-1 hash with `df` prefix removed (full hash = `df` + filename)
...
- **Do not rename** — Folder name (`df`) is part of the SHA-1 addressing scheme

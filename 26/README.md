...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `26`.
...
- **Naming**: SHA-1 hash with `26` prefix removed (full hash = `26` + filename)
...
- **Do not rename** — Folder name (`26`) is part of the SHA-1 addressing scheme

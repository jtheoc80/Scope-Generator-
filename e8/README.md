...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e8`.
...
- **Naming**: SHA-1 hash with `e8` prefix removed (full hash = `e8` + filename)
...
- **Do not rename** — Folder name (`e8`) is part of the SHA-1 addressing scheme

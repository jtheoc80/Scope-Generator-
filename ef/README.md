...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ef`.
...
- **Naming**: SHA-1 hash with `ef` prefix removed (full hash = `ef` + filename)
...
- **Do not rename** — Folder name (`ef`) is part of the SHA-1 addressing scheme

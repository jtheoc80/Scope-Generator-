...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a9`.
...
- **Naming**: SHA-1 hash with `a9` prefix removed (full hash = `a9` + filename)
...
- **Do not rename** — Folder name (`a9`) is part of the SHA-1 addressing scheme

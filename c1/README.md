...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c1`.
...
- **Naming**: SHA-1 hash with `c1` prefix removed (full hash = `c1` + filename)
...
- **Do not rename** — Folder name (`c1`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a4`.
...
- **Naming**: SHA-1 hash with `a4` prefix removed (full hash = `a4` + filename)
...
- **Do not rename** — Folder name (`a4`) is part of the SHA-1 addressing scheme

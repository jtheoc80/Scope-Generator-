...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `63`.
...
- **Naming**: SHA-1 hash with `63` prefix removed (full hash = `63` + filename)
...
- **Do not rename** — Folder name (`63`) is part of the SHA-1 addressing scheme

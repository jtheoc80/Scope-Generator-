...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `45`.
...
- **Naming**: SHA-1 hash with `45` prefix removed (full hash = `45` + filename)
...
- **Do not rename** — Folder name (`45`) is part of the SHA-1 addressing scheme

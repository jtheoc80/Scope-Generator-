...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `3c`.
...
- **Naming**: SHA-1 hash with `3c` prefix removed (full hash = `3c` + filename)
...
- **Do not rename** — Folder name (`3c`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `70`.
...
- **Naming**: SHA-1 hash with `70` prefix removed (full hash = `70` + filename)
...
- **Do not rename** — Folder name (`70`) is part of the SHA-1 addressing scheme

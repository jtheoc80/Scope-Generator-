...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `8b`.
...
- **Naming**: SHA-1 hash with `8b` prefix removed (full hash = `8b` + filename)
...
- **Do not rename** — Folder name (`8b`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `19`.
...
- **Naming**: SHA-1 hash with `19` prefix removed (full hash = `19` + filename)
...
- **Do not rename** — Folder name (`19`) is part of the SHA-1 addressing scheme

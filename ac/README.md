...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ac`.
...
- **Naming**: SHA-1 hash with `ac` prefix removed (full hash = `ac` + filename)
...
- **Do not rename** — Folder name (`ac`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `1e`.
...
- **Naming**: SHA-1 hash with `1e` prefix removed (full hash = `1e` + filename)
...
- **Do not rename** — Folder name (`1e`) is part of the SHA-1 addressing scheme

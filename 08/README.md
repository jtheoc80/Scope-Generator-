...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `08`.
...
- **Naming**: SHA-1 hash with `08` prefix removed (full hash = `08` + filename)
...
- **Do not rename** — Folder name (`08`) is part of the SHA-1 addressing scheme

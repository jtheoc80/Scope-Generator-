...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `07`.
...
- **Naming**: SHA-1 hash with `07` prefix removed (full hash = `07` + filename)
...
- **Do not rename** — Folder name (`07`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `85`.
...
- **Naming**: SHA-1 hash with `85` prefix removed (full hash = `85` + filename)
...
- **Do not rename** — Folder name (`85`) is part of the SHA-1 addressing scheme

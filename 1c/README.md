...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `1c`.
...
- **Naming**: SHA-1 hash with `1c` prefix removed (full hash = `1c` + filename)
...
- **Do not rename** — Folder name (`1c`) is part of the SHA-1 addressing scheme

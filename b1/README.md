...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b1`.
...
- **Naming**: SHA-1 hash with `b1` prefix removed (full hash = `b1` + filename)
...
- **Do not rename** — Folder name (`b1`) is part of the SHA-1 addressing scheme

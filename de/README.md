...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `de`.
...
- **Naming**: SHA-1 hash with `de` prefix removed (full hash = `de` + filename)
...
- **Do not rename** — Folder name (`de`) is part of the SHA-1 addressing scheme

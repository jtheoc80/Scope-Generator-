...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `8f`.
...
- **Naming**: SHA-1 hash with `8f` prefix removed (full hash = `8f` + filename)
...
- **Do not rename** — Folder name (`8f`) is part of the SHA-1 addressing scheme

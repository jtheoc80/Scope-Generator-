...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `7e`.
...
- **Naming**: SHA-1 hash with `7e` prefix removed (full hash = `7e` + filename)
...
- **Do not rename** — Folder name (`7e`) is part of the SHA-1 addressing scheme

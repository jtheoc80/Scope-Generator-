...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `6e`.
...
- **Naming**: SHA-1 hash with `6e` prefix removed (full hash = `6e` + filename)
...
- **Do not rename** — Folder name (`6e`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `9f`.
...
- **Naming**: SHA-1 hash with `9f` prefix removed (full hash = `9f` + filename)
...
- **Do not rename** — Folder name (`9f`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `95`.
...
- **Naming**: SHA-1 hash with `95` prefix removed (full hash = `95` + filename)
...
- **Do not rename** — Folder name (`95`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `65`.
...
- **Naming**: SHA-1 hash with `65` prefix removed (full hash = `65` + filename)
...
- **Do not rename** — Folder name (`65`) is part of the SHA-1 addressing scheme

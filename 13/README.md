...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `13`.
...
- **Naming**: SHA-1 hash with `13` prefix removed (full hash = `13` + filename)
...
- **Do not rename** — Folder name (`13`) is part of the SHA-1 addressing scheme

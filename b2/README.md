...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b2`.
...
- **Naming**: SHA-1 hash with `b2` prefix removed (full hash = `b2` + filename)
...
- **Do not rename** — Folder name (`b2`) is part of the SHA-1 addressing scheme

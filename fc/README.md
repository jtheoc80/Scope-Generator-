...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `fc`.
...
- **Naming**: SHA-1 hash with `fc` prefix removed (full hash = `fc` + filename)
...
- **Do not rename** — Folder name (`fc`) is part of the SHA-1 addressing scheme

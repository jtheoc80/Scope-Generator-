...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `33`.
...
- **Naming**: SHA-1 hash with `33` prefix removed (full hash = `33` + filename)
...
- **Do not rename** — Folder name (`33`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `50`.
...
- **Naming**: SHA-1 hash with `50` prefix removed (full hash = `50` + filename)
...
- **Do not rename** — Folder name (`50`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `61`.
...
- **Naming**: SHA-1 hash with `61` prefix removed (full hash = `61` + filename)
...
- **Do not rename** — Folder name (`61`) is part of the SHA-1 addressing scheme

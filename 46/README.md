...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `46`.
...
- **Naming**: SHA-1 hash with `46` prefix removed (full hash = `46` + filename)
...
- **Do not rename** — Folder name (`46`) is part of the SHA-1 addressing scheme

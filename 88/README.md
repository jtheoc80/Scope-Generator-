...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `88`.
...
- **Naming**: SHA-1 hash with `88` prefix removed (full hash = `88` + filename)
...
- **Do not rename** — Folder name (`88`) is part of the SHA-1 addressing scheme

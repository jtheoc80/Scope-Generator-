...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c8`.
...
- **Naming**: SHA-1 hash with `c8` prefix removed (full hash = `c8` + filename)
...
- **Do not rename** — Folder name (`c8`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `71`.
...
- **Naming**: SHA-1 hash with `71` prefix removed (full hash = `71` + filename)
...
- **Do not rename** — Folder name (`71`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ae`.
...
- **Naming**: SHA-1 hash with `ae` prefix removed (full hash = `ae` + filename)
...
- **Do not rename** — Folder name (`ae`) is part of the SHA-1 addressing scheme

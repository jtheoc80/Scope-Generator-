...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `0b`.
...
- **Naming**: SHA-1 hash with `0b` prefix removed (full hash = `0b` + filename)
...
- **Do not rename** — Folder name (`0b`) is part of the SHA-1 addressing scheme

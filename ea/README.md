...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ea`.
...
- **Naming**: SHA-1 hash with `ea` prefix removed (full hash = `ea` + filename)
...
- **Do not rename** — Folder name (`ea`) is part of the SHA-1 addressing scheme

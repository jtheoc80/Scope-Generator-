...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `3b`.
...
- **Naming**: SHA-1 hash with `3b` prefix removed (full hash = `3b` + filename)
...
- **Do not rename** — Folder name (`3b`) is part of the SHA-1 addressing scheme

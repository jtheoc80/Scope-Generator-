...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `6c`.
...
- **Naming**: SHA-1 hash with `6c` prefix removed (full hash = `6c` + filename)
...
- **Do not rename** — Folder name (`6c`) is part of the SHA-1 addressing scheme

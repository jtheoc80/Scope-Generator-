...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `0d`.
...
- **Naming**: SHA-1 hash with `0d` prefix removed (full hash = `0d` + filename)
...
- **Do not rename** — Folder name (`0d`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `82`.
...
- **Naming**: SHA-1 hash with `82` prefix removed (full hash = `82` + filename)
...
- **Do not rename** — Folder name (`82`) is part of the SHA-1 addressing scheme

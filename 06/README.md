...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `06`.
...
- **Naming**: SHA-1 hash with `06` prefix removed (full hash = `06` + filename)
...
- **Do not rename** — Folder name (`06`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `36`.
...
- **Naming**: SHA-1 hash with `36` prefix removed (full hash = `36` + filename)
...
- **Do not rename** — Folder name (`36`) is part of the SHA-1 addressing scheme

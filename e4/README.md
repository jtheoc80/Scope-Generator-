...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e4`.
...
- **Naming**: SHA-1 hash with `e4` prefix removed (full hash = `e4` + filename)
...
- **Do not rename** — Folder name (`e4`) is part of the SHA-1 addressing scheme

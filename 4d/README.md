...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `4d`.
...
- **Naming**: SHA-1 hash with `4d` prefix removed (full hash = `4d` + filename)
...
- **Do not rename** — Folder name (`4d`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a1`.
...
- **Naming**: SHA-1 hash with `a1` prefix removed (full hash = `a1` + filename)
...
- **Do not rename** — Folder name (`a1`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `02`.
...
- **Naming**: SHA-1 hash with `02` prefix removed (full hash = `02` + filename)
...
- **Do not rename** — Folder name (`02`) is part of the SHA-1 addressing scheme

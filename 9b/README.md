...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `9b`.
...
- **Naming**: SHA-1 hash with `9b` prefix removed (full hash = `9b` + filename)
...
- **Do not rename** — Folder name (`9b`) is part of the SHA-1 addressing scheme

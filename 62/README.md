...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `62`.
...
- **Naming**: SHA-1 hash with `62` prefix removed (full hash = `62` + filename)
...
- **Do not rename** — Folder name (`62`) is part of the SHA-1 addressing scheme

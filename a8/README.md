...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a8`.
...
- **Naming**: SHA-1 hash with `a8` prefix removed (full hash = `a8` + filename)
...
- **Do not rename** — Folder name (`a8`) is part of the SHA-1 addressing scheme

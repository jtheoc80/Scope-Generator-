...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `bd`.
...
- **Naming**: SHA-1 hash with `bd` prefix removed (full hash = `bd` + filename)
...
- **Do not rename** — Folder name (`bd`) is part of the SHA-1 addressing scheme

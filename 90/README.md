...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `90`.
...
- **Naming**: SHA-1 hash with `90` prefix removed (full hash = `90` + filename)
...
- **Do not rename** — Folder name (`90`) is part of the SHA-1 addressing scheme

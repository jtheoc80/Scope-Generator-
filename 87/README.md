...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `87`.
...
- **Naming**: SHA-1 hash with `87` prefix removed (full hash = `87` + filename)
...
- **Do not rename** — Folder name (`87`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `29`.
...
- **Naming**: SHA-1 hash with `29` prefix removed (full hash = `29` + filename)
...
- **Do not rename** — Folder name (`29`) is part of the SHA-1 addressing scheme

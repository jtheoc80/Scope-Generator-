...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `72`.
...
- **Naming**: SHA-1 hash with `72` prefix removed (full hash = `72` + filename)
...
- **Do not rename** — Folder name (`72`) is part of the SHA-1 addressing scheme

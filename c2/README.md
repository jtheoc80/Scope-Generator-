...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c2`.
...
- **Naming**: SHA-1 hash with `c2` prefix removed (full hash = `c2` + filename)
...
- **Do not rename** — Folder name (`c2`) is part of the SHA-1 addressing scheme

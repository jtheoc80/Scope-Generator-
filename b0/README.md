...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b0`.
...
- **Naming**: SHA-1 hash with `b0` prefix removed (full hash = `b0` + filename)
...
- **Do not rename** — Folder name (`b0`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `9e`.
...
- **Naming**: SHA-1 hash with `9e` prefix removed (full hash = `9e` + filename)
...
- **Do not rename** — Folder name (`9e`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `24`.
...
- **Naming**: SHA-1 hash with `24` prefix removed (full hash = `24` + filename)
...
- **Do not rename** — Folder name (`24`) is part of the SHA-1 addressing scheme

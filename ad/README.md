...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ad`.
...
- **Naming**: SHA-1 hash with `ad` prefix removed (full hash = `ad` + filename)
...
- **Do not rename** — Folder name (`ad`) is part of the SHA-1 addressing scheme

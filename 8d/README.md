...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `8d`.
...
- **Naming**: SHA-1 hash with `8d` prefix removed (full hash = `8d` + filename)
...
- **Do not rename** — Folder name (`8d`) is part of the SHA-1 addressing scheme

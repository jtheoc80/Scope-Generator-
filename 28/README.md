...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `28`.
...
- **Naming**: SHA-1 hash with `28` prefix removed (full hash = `28` + filename)
...
- **Do not rename** — Folder name (`28`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ba`.
...
- **Naming**: SHA-1 hash with `ba` prefix removed (full hash = `ba` + filename)
...
- **Do not rename** — Folder name (`ba`) is part of the SHA-1 addressing scheme

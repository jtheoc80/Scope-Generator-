...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `8e`.
...
- **Naming**: SHA-1 hash with `8e` prefix removed (full hash = `8e` + filename)
...
- **Do not rename** — Folder name (`8e`) is part of the SHA-1 addressing scheme

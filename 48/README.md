...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `48`.
...
- **Naming**: SHA-1 hash with `48` prefix removed (full hash = `48` + filename)
...
- **Do not rename** — Folder name (`48`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c0`.
...
- **Naming**: SHA-1 hash with `c0` prefix removed (full hash = `c0` + filename)
...
- **Do not rename** — Folder name (`c0`) is part of the SHA-1 addressing scheme

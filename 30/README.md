...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `30`.
...
- **Naming**: SHA-1 hash with `30` prefix removed (full hash = `30` + filename)
...
- **Do not rename** — Folder name (`30`) is part of the SHA-1 addressing scheme

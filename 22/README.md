...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `22`.
...
- **Naming**: SHA-1 hash with `22` prefix removed (full hash = `22` + filename)
...
- **Do not rename** — Folder name (`22`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d0`.
...
- **Naming**: SHA-1 hash with `d0` prefix removed (full hash = `d0` + filename)
...
- **Do not rename** — Folder name (`d0`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `eb`.
...
- **Naming**: SHA-1 hash with `eb` prefix removed (full hash = `eb` + filename)
...
- **Do not rename** — Folder name (`eb`) is part of the SHA-1 addressing scheme

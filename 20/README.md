...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `20`.
...
- **Naming**: SHA-1 hash with `20` prefix removed (full hash = `20` + filename)
...
- **Do not rename** — Folder name (`20`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `6a`.
...
- **Naming**: SHA-1 hash with `6a` prefix removed (full hash = `6a` + filename)
...
- **Do not rename** — Folder name (`6a`) is part of the SHA-1 addressing scheme

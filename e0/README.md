...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e0`.
...
- **Naming**: SHA-1 hash with `e0` prefix removed (full hash = `e0` + filename)
...
- **Do not rename** — Folder name (`e0`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `98`.
...
- **Naming**: SHA-1 hash with `98` prefix removed (full hash = `98` + filename)
...
- **Do not rename** — Folder name (`98`) is part of the SHA-1 addressing scheme

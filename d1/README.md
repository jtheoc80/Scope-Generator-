...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d1`.
...
- **Naming**: SHA-1 hash with `d1` prefix removed (full hash = `d1` + filename)
...
- **Do not rename** — Folder name (`d1`) is part of the SHA-1 addressing scheme

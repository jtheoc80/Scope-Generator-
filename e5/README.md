...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e5`.
...
- **Naming**: SHA-1 hash with `e5` prefix removed (full hash = `e5` + filename)
...
- **Do not rename** — Folder name (`e5`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `3d`.
...
- **Naming**: SHA-1 hash with `3d` prefix removed (full hash = `3d` + filename)
...
- **Do not rename** — Folder name (`3d`) is part of the SHA-1 addressing scheme

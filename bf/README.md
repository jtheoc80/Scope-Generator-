...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `bf`.
...
- **Naming**: SHA-1 hash with `bf` prefix removed (full hash = `bf` + filename)
...
- **Do not rename** — Folder name (`bf`) is part of the SHA-1 addressing scheme

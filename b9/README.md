...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b9`.
...
- **Naming**: SHA-1 hash with `b9` prefix removed (full hash = `b9` + filename)
...
- **Do not rename** — Folder name (`b9`) is part of the SHA-1 addressing scheme

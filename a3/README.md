...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a3`.
...
- **Naming**: SHA-1 hash with `a3` prefix removed (full hash = `a3` + filename)
...
- **Do not rename** — Folder name (`a3`) is part of the SHA-1 addressing scheme

    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-6">
        <div className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="text-xl font-semibold text-slate-900">Sign up coming soon!</h1>
          <p className="mt-2 text-sm text-slate-600">
            We&apos;re setting up user accounts with a 60-day free trial. In the meantime, you can still use our proposal generator!
          </p>
          <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm font-medium text-green-800">
              🎉 Good news! You can create proposals right now without signing up.
            </p>
            <p className="text-xs text-green-700 mt-1">
              When accounts are ready, you&apos;ll get 60 days free to try all features.
            </p>
          </div>
          <div className="mt-6 flex flex-col gap-3">
            <Link
              href="/generator"
              className="inline-flex items-center justify-center rounded-md bg-orange-500 px-4 py-3 text-sm font-semibold text-white hover:bg-orange-600 transition-colors"
            >
              Try the Proposal Generator →
            </Link>
            <Link
              href="/"

    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-6">
        <div className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="text-xl font-semibold text-slate-900">Sign in temporarily unavailable</h1>
          <p className="mt-2 text-sm text-slate-600">
            We&apos;re setting up user accounts. In the meantime, you can still use our proposal generator!
          </p>
          <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm font-medium text-green-800">
              🎉 Good news! You can create proposals right now without signing in.
            </p>
          </div>

...
export default function CalculatorPage() {
  ...
  }, [selectedTrade, selectedJobType, selectedSize, customSqFt, regionalMultiplier, canCalculate, jobType, size, trade]);
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-slate-600 text-lg leading-relaxed mb-4">
                Our contractor price calculator uses a combination of industry data, regional cost indices, and real-world project data to provide accurate estimates. Here is how it works:
              </p>

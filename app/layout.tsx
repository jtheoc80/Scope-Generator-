...
export const metadata: Metadata = {
  ...
  description: "Generate professional contractor proposals and scopes of work in 60 seconds. Built for kitchen and bathroom remodelers, electricians, HVAC techs, plumbers, and more.",
  keywords: ["contractor proposal software", "scope of work generator", "construction proposal", "remodeling proposal", "contractor estimates", "kitchen proposal", "bathroom proposal", "electrical proposal", "HVAC proposal", "plumbing proposal"],

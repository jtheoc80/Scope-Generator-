...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `1f`.
...
- **Naming**: SHA-1 hash with `1f` prefix removed (full hash = `1f` + filename)
...
- **Do not rename** — Folder name (`1f`) is part of the SHA-1 addressing scheme

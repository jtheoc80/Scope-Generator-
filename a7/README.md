...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a7`.
...
- **Naming**: SHA-1 hash with `a7` prefix removed (full hash = `a7` + filename)
...
- **Do not rename** — Folder name (`a7`) is part of the SHA-1 addressing scheme

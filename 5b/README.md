...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `5b`.
...
- **Naming**: SHA-1 hash with `5b` prefix removed (full hash = `5b` + filename)
...
- **Do not rename** — Folder name (`5b`) is part of the SHA-1 addressing scheme

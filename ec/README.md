...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ec`.
...
- **Naming**: SHA-1 hash with `ec` prefix removed (full hash = `ec` + filename)
...
- **Do not rename** — Folder name (`ec`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `89`.
...
- **Naming**: SHA-1 hash with `89` prefix removed (full hash = `89` + filename)
...
- **Do not rename** — Folder name (`89`) is part of the SHA-1 addressing scheme

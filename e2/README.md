...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e2`.
...
- **Naming**: SHA-1 hash with `e2` prefix removed (full hash = `e2` + filename)
...
- **Do not rename** — Folder name (`e2`) is part of the SHA-1 addressing scheme

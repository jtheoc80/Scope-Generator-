...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `49`.
...
- **Naming**: SHA-1 hash with `49` prefix removed (full hash = `49` + filename)
...
- **Do not rename** — Folder name (`49`) is part of the SHA-1 addressing scheme

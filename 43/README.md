...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `43`.
...
- **Naming**: SHA-1 hash with `43` prefix removed (full hash = `43` + filename)
...
- **Do not rename** — Folder name (`43`) is part of the SHA-1 addressing scheme

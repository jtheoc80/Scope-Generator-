...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a2`.
...
- **Naming**: SHA-1 hash with `a2` prefix removed (full hash = `a2` + filename)
...
- **Do not rename** — Folder name (`a2`) is part of the SHA-1 addressing scheme

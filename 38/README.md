...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `38`.
...
- **Naming**: SHA-1 hash with `38` prefix removed (full hash = `38` + filename)
...
- **Do not rename** — Folder name (`38`) is part of the SHA-1 addressing scheme

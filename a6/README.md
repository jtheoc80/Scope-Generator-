...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a6`.
...
- **Naming**: SHA-1 hash with `a6` prefix removed (full hash = `a6` + filename)
...
- **Do not rename** — Folder name (`a6`) is part of the SHA-1 addressing scheme

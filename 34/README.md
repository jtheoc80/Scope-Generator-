...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `34`.
...
- **Naming**: SHA-1 hash with `34` prefix removed (full hash = `34` + filename)
...
- **Do not rename** — Folder name (`34`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `05`.
...
- **Naming**: SHA-1 hash with `05` prefix removed (full hash = `05` + filename)
...
- **Do not rename** — Folder name (`05`) is part of the SHA-1 addressing scheme

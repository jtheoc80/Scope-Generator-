...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `6d`.
...
- **Naming**: SHA-1 hash with `6d` prefix removed (full hash = `6d` + filename)
...
- **Do not rename** — Folder name (`6d`) is part of the SHA-1 addressing scheme

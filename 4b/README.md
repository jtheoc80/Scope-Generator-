...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `4b`.
...
- **Naming**: SHA-1 hash with `4b` prefix removed (full hash = `4b` + filename)
...
- **Do not rename** — Folder name (`4b`) is part of the SHA-1 addressing scheme

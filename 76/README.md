...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `76`.
...
- **Naming**: SHA-1 hash with `76` prefix removed (full hash = `76` + filename)
...
- **Do not rename** — Folder name (`76`) is part of the SHA-1 addressing scheme

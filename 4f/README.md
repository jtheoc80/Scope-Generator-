...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `4f`.
...
- **Naming**: SHA-1 hash with `4f` prefix removed (full hash = `4f` + filename)
...
- **Do not rename** — Folder name (`4f`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b5`.
...
- **Naming**: SHA-1 hash with `b5` prefix removed (full hash = `b5` + filename)
...
- **Do not rename** — Folder name (`b5`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ed`.
...
- **Naming**: SHA-1 hash with `ed` prefix removed (full hash = `ed` + filename)
...
- **Do not rename** — Folder name (`ed`) is part of the SHA-1 addressing scheme

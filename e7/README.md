...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e7`.
...
- **Naming**: SHA-1 hash with `e7` prefix removed (full hash = `e7` + filename)
...
- **Do not rename** — Folder name (`e7`) is part of the SHA-1 addressing scheme

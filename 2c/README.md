...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `2c`.
...
- **Naming**: SHA-1 hash with `2c` prefix removed (full hash = `2c` + filename)
...
- **Do not rename** — Folder name (`2c`) is part of the SHA-1 addressing scheme

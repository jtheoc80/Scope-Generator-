...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `8a`.
...
- **Naming**: SHA-1 hash with `8a` prefix removed (full hash = `8a` + filename)
...
- **Do not rename** — Folder name (`8a`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `0f`.
...
- **Naming**: SHA-1 hash with `0f` prefix removed (full hash = `0f` + filename)
...
- **Do not rename** — Folder name (`0f`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `fd`.
...
- **Naming**: SHA-1 hash with `fd` prefix removed (full hash = `fd` + filename)
...
- **Do not rename** — Folder name (`fd`) is part of the SHA-1 addressing scheme

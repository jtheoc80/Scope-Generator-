...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `44`.
...
- **Naming**: SHA-1 hash with `44` prefix removed (full hash = `44` + filename)
...
- **Do not rename** — Folder name (`44`) is part of the SHA-1 addressing scheme

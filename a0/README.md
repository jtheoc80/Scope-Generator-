...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `a0`.
...
- **Naming**: SHA-1 hash with `a0` prefix removed (full hash = `a0` + filename)
...
- **Do not rename** — Folder name (`a0`) is part of the SHA-1 addressing scheme

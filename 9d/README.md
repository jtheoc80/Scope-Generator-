...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `9d`.
...
- **Naming**: SHA-1 hash with `9d` prefix removed (full hash = `9d` + filename)
...
- **Do not rename** — Folder name (`9d`) is part of the SHA-1 addressing scheme

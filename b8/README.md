...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b8`.
...
- **Naming**: SHA-1 hash with `b8` prefix removed (full hash = `b8` + filename)
...
- **Do not rename** — Folder name (`b8`) is part of the SHA-1 addressing scheme

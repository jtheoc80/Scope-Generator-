...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `4a`.
...
- **Naming**: SHA-1 hash with `4a` prefix removed (full hash = `4a` + filename)
...
- **Do not rename** — Folder name (`4a`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `23`.
...
- **Naming**: SHA-1 hash with `23` prefix removed (full hash = `23` + filename)
...
- **Do not rename** — Folder name (`23`) is part of the SHA-1 addressing scheme

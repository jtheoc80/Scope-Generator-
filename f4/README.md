...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f4`.
...
- **Naming**: SHA-1 hash with `f4` prefix removed (full hash = `f4` + filename)
...
- **Do not rename** — Folder name (`f4`) is part of the SHA-1 addressing scheme

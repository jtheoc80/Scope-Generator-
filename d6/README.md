...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d6`.
...
- **Naming**: SHA-1 hash with `d6` prefix removed (full hash = `d6` + filename)
...
- **Do not rename** — Folder name (`d6`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `e6`.
...
- **Naming**: SHA-1 hash with `e6` prefix removed (full hash = `e6` + filename)
...
- **Do not rename** — Folder name (`e6`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f9`.
...
- **Naming**: SHA-1 hash with `f9` prefix removed (full hash = `f9` + filename)
...
- **Do not rename** — Folder name (`f9`) is part of the SHA-1 addressing scheme

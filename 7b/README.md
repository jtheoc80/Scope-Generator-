...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `7b`.
...
- **Naming**: SHA-1 hash with `7b` prefix removed (full hash = `7b` + filename)
...
- **Do not rename** — Folder name (`7b`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `47`.
...
- **Naming**: SHA-1 hash with `47` prefix removed (full hash = `47` + filename)
...
- **Do not rename** — Folder name (`47`) is part of the SHA-1 addressing scheme

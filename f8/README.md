...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f8`.
...
- **Naming**: SHA-1 hash with `f8` prefix removed (full hash = `f8` + filename)
...
- **Do not rename** — Folder name (`f8`) is part of the SHA-1 addressing scheme

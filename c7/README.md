...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c7`.
...
- **Naming**: SHA-1 hash with `c7` prefix removed (full hash = `c7` + filename)
...
- **Do not rename** — Folder name (`c7`) is part of the SHA-1 addressing scheme

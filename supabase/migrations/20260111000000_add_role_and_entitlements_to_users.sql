-- Migration: Add role and entitlements columns to users table
-- This migration adds role-based access control and entitlements for fine-grained permissions
...
-- Create audit_log table for tracking entitlement changes (if not exists)

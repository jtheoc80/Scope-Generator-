...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f6`.
...
- **Naming**: SHA-1 hash with `f6` prefix removed (full hash = `f6` + filename)
...
- **Do not rename** — Folder name (`f6`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `80`.
...
- **Naming**: SHA-1 hash with `80` prefix removed (full hash = `80` + filename)
...
- **Do not rename** — Folder name (`80`) is part of the SHA-1 addressing scheme

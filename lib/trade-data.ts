/**
 * Trade Landing Page Data
 * Contains all trade-specific content for SEO landing pages
 */
...
export const cityData: Record<string, CityData> = {
  ...
  "phoenix": {
    name: "Phoenix",
    state: "AZ",
    tagline: "Serving the Phoenix Metro Area",
    population: "1.6M+"
  },
  "los-angeles": {
    name: "Los Angeles",
    state: "CA",
    tagline: "Serving Greater Los Angeles",
    population: "3.9M+"
  },
  "san-diego": {
    name: "San Diego",
    state: "CA",
    tagline: "Serving San Diego County",
    population: "1.4M+"
  },
  "denver": {
    name: "Denver",
    state: "CO",
    tagline: "Serving the Denver Metro Area",
    population: "715K+"
  },
  "miami": {
    name: "Miami",
    state: "FL",
    tagline: "Serving South Florida",
    population: "450K+"
  },
  "atlanta": {
    name: "Atlanta",
    state: "GA",
    tagline: "Serving Metro Atlanta",
    population: "500K+"
  },
  "chicago": {
    name: "Chicago",
    state: "IL",
    tagline: "Serving Chicagoland",
    population: "2.7M+"
  }
};
...
// Helper to get all trade slugs
export const getTradeKeys = () => Object.keys(tradeData);

// Helper to get trade by slug
export const getTradeBySlug = (slug: string) => tradeData[slug];

// Helper to check if a trade supports city-specific pages
export const tradeSupportsCities = (tradeSlug: string) => tradeCityRoutes.includes(tradeSlug);

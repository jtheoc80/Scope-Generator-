...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `5c`.
...
- **Naming**: SHA-1 hash with `5c` prefix removed (full hash = `5c` + filename)
...
- **Do not rename** — Folder name (`5c`) is part of the SHA-1 addressing scheme

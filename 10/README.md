...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `10`.
...
- **Naming**: SHA-1 hash with `10` prefix removed (full hash = `10` + filename)
...
- **Do not rename** — Folder name (`10`) is part of the SHA-1 addressing scheme

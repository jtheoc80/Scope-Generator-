...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `be`.
...
- **Naming**: SHA-1 hash with `be` prefix removed (full hash = `be` + filename)
...
- **Do not rename** — Folder name (`be`) is part of the SHA-1 addressing scheme

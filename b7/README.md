...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b7`.
...
- **Naming**: SHA-1 hash with `b7` prefix removed (full hash = `b7` + filename)
...
- **Do not rename** — Folder name (`b7`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `40`.
...
- **Naming**: SHA-1 hash with `40` prefix removed (full hash = `40` + filename)
...
- **Do not rename** — Folder name (`40`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d4`.
...
- **Naming**: SHA-1 hash with `d4` prefix removed (full hash = `d4` + filename)
...
- **Do not rename** — Folder name (`d4`) is part of the SHA-1 addressing scheme

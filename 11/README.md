...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `11`.
...
- **Naming**: SHA-1 hash with `11` prefix removed (full hash = `11` + filename)
...
- **Do not rename** — Folder name (`11`) is part of the SHA-1 addressing scheme

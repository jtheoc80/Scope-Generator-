...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `bb`.
...
- **Naming**: SHA-1 hash with `bb` prefix removed (full hash = `bb` + filename)
...
- **Do not rename** — Folder name (`bb`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c4`.
...
- **Naming**: SHA-1 hash with `c4` prefix removed (full hash = `c4` + filename)
...
- **Do not rename** — Folder name (`c4`) is part of the SHA-1 addressing scheme

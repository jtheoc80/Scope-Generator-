...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `03`.
...
- **Naming**: SHA-1 hash with `03` prefix removed (full hash = `03` + filename)
...
- **Do not rename** — Folder name (`03`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `2d`.
...
- **Naming**: SHA-1 hash with `2d` prefix removed (full hash = `2d` + filename)
...
- **Do not rename** — Folder name (`2d`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f7`.
...
- **Naming**: SHA-1 hash with `f7` prefix removed (full hash = `f7` + filename)
...
- **Do not rename** — Folder name (`f7`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `2a`.
...
- **Naming**: SHA-1 hash with `2a` prefix removed (full hash = `2a` + filename)
...
- **Do not rename** — Folder name (`2a`) is part of the SHA-1 addressing scheme

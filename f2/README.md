...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `f2`.
...
- **Naming**: SHA-1 hash with `f2` prefix removed (full hash = `f2` + filename)
...
- **Do not rename** — Folder name (`f2`) is part of the SHA-1 addressing scheme

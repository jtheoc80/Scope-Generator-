...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `91`.
...
- **Naming**: SHA-1 hash with `91` prefix removed (full hash = `91` + filename)
...
- **Do not rename** — Folder name (`91`) is part of the SHA-1 addressing scheme

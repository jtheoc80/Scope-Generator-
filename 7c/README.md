...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `7c`.
...
- **Naming**: SHA-1 hash with `7c` prefix removed (full hash = `7c` + filename)
...
- **Do not rename** — Folder name (`7c`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `bc`.
...
- **Naming**: SHA-1 hash with `bc` prefix removed (full hash = `bc` + filename)
...
- **Do not rename** — Folder name (`bc`) is part of the SHA-1 addressing scheme

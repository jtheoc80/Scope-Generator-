...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `0e`.
...
- **Naming**: SHA-1 hash with `0e` prefix removed (full hash = `0e` + filename)
...
- **Do not rename** — Folder name (`0e`) is part of the SHA-1 addressing scheme

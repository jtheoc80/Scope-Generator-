...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `1a`.
...
- **Naming**: SHA-1 hash with `1a` prefix removed (full hash = `1a` + filename)
...
- **Do not rename** — Folder name (`1a`) is part of the SHA-1 addressing scheme

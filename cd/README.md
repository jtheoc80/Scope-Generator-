...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `cd`.
...
- **Naming**: SHA-1 hash with `cd` prefix removed (full hash = `cd` + filename)
...
- **Do not rename** — Folder name (`cd`) is part of the SHA-1 addressing scheme

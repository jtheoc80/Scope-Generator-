...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `dd`.
...
- **Naming**: SHA-1 hash with `dd` prefix removed (full hash = `dd` + filename)
...
- **Do not rename** — Folder name (`dd`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `7f`.
...
- **Naming**: SHA-1 hash with `7f` prefix removed (full hash = `7f` + filename)
...
- **Do not rename** — Folder name (`7f`) is part of the SHA-1 addressing scheme

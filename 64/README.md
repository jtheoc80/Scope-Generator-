...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `64`.
...
- **Naming**: SHA-1 hash with `64` prefix removed (full hash = `64` + filename)
...
- **Do not rename** — Folder name (`64`) is part of the SHA-1 addressing scheme

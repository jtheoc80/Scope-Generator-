...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d7`.
...
- **Naming**: SHA-1 hash with `d7` prefix removed (full hash = `d7` + filename)
...
- **Do not rename** — Folder name (`d7`) is part of the SHA-1 addressing scheme

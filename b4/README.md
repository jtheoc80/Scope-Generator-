...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b4`.
...
- **Naming**: SHA-1 hash with `b4` prefix removed (full hash = `b4` + filename)
...
- **Do not rename** — Folder name (`b4`) is part of the SHA-1 addressing scheme

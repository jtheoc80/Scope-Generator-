...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `78`.
...
- **Naming**: SHA-1 hash with `78` prefix removed (full hash = `78` + filename)
...
- **Do not rename** — Folder name (`78`) is part of the SHA-1 addressing scheme

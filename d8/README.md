...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d8`.
...
- **Naming**: SHA-1 hash with `d8` prefix removed (full hash = `d8` + filename)
...
- **Do not rename** — Folder name (`d8`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `32`.
...
- **Naming**: SHA-1 hash with `32` prefix removed (full hash = `32` + filename)
...
- **Do not rename** — Folder name (`32`) is part of the SHA-1 addressing scheme

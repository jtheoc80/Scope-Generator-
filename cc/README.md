...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `cc`.
...
- **Naming**: SHA-1 hash with `cc` prefix removed (full hash = `cc` + filename)
...
- **Do not rename** — Folder name (`cc`) is part of the SHA-1 addressing scheme

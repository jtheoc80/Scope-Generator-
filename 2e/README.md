...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `2e`.
...
- **Naming**: SHA-1 hash with `2e` prefix removed (full hash = `2e` + filename)
...
- **Do not rename** — Folder name (`2e`) is part of the SHA-1 addressing scheme

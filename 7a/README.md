...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `7a`.
...
- **Naming**: SHA-1 hash with `7a` prefix removed (full hash = `7a` + filename)
...
- **Do not rename** — Folder name (`7a`) is part of the SHA-1 addressing scheme

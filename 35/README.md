...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `35`.
...
- **Naming**: SHA-1 hash with `35` prefix removed (full hash = `35` + filename)
...
- **Do not rename** — Folder name (`35`) is part of the SHA-1 addressing scheme

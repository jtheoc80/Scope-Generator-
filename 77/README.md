...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `77`.
...
- **Naming**: SHA-1 hash with `77` prefix removed (full hash = `77` + filename)
...
- **Do not rename** — Folder name (`77`) is part of the SHA-1 addressing scheme

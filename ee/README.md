...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `ee`.
...
- **Naming**: SHA-1 hash with `ee` prefix removed (full hash = `ee` + filename)
...
- **Do not rename** — Folder name (`ee`) is part of the SHA-1 addressing scheme

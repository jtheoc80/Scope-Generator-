...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `0c`.
...
- **Naming**: SHA-1 hash with `0c` prefix removed (full hash = `0c` + filename)
...
- **Do not rename** — Folder name (`0c`) is part of the SHA-1 addressing scheme

...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `b6`.
...
- **Naming**: SHA-1 hash with `b6` prefix removed (full hash = `b6` + filename)
...
- **Do not rename** — Folder name (`b6`) is part of the SHA-1 addressing scheme

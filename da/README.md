...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `da`.
...
- **Naming**: SHA-1 hash with `da` prefix removed (full hash = `da` + filename)
...
- **Do not rename** — Folder name (`da`) is part of the SHA-1 addressing scheme

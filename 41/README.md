...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `41`.
...
- **Naming**: SHA-1 hash with `41` prefix removed (full hash = `41` + filename)
...
- **Do not rename** — Folder name (`41`) is part of the SHA-1 addressing scheme

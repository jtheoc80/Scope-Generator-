...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `c9`.
...
- **Naming**: SHA-1 hash with `c9` prefix removed (full hash = `c9` + filename)
...
- **Do not rename** — Folder name (`c9`) is part of the SHA-1 addressing scheme

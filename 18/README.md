...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `18`.
...
- **Naming**: SHA-1 hash with `18` prefix removed (full hash = `18` + filename)
...
- **Do not rename** — Folder name (`18`) is part of the SHA-1 addressing scheme

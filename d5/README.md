...
This folder is part of a **Git object database** backup. It contains Git objects whose SHA-1 hash begins with `d5`.
...
- **Naming**: SHA-1 hash with `d5` prefix removed (full hash = `d5` + filename)
...
- **Do not rename** — Folder name (`d5`) is part of the SHA-1 addressing scheme
